...
\indent The measured battery voltage with the light has decreased from 3.004 volts to 2.844 volts. We don't however conclude that the difference in voltage is a direct result of the addition of the light bulb.  Instead it is likely that the batteries voltage has dropped as the result of use; Note that the voltage measured across the battery was done half an hour before that of the voltage drop with the light bulb in the current. The current flowing through the bulb was measured to be 8.43 Amps.\\ \\
